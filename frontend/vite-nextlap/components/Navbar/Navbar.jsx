    ...
    <nav className="bg-red-600 border-b border-red-700 px-6 py-3 flex justify-between items-center sticky top-0 z-50 shadow-md">
      ...
      <div className="flex-1 max-w-md mx-10">
        <div className="relative">
          <input
            type="text"
            placeholder="Search for laptops, brands, or gear..."
            onChange={(e) => setSearchQuery(e.target.value)}
            className="w-full pl-10 pr-4 py-2 bg-gray-100 border-none rounded-full focus:ring-2 focus:ring-red-500 transition-all text-sm"
          />
          <svg
